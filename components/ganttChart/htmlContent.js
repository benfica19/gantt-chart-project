      ...
      <form id="add-task-duration">
        ...
        <div class="inner-form-container">
          ...
          <fieldset id="date">
            ...
            <input type="date" id="start-date" name="start-date" value="2022-01-01" min="2022-01-01" max="2050-12-31">

            <label for="end-date">End date:</label>
            <input type="date" id="end-date" name="end-date" value="2022-01-03" min="2022-01-01" max="2050-12-31">
          </fieldset>
        </div>
        <button>
          Add
